...
class Build : NukeBuild
{
  ...
  Target CreateEmbeddedLandingPageZip => _ => _
    ...
    .Executes(() =>
    {
      ...
      try
      {
        WriteAllText(landingPageIndexPath, originalLandingPageIndexContent.Replace("@@PLUGIN_VERSION@@", "2.3.4"));
  ...
  Target Compile => _ => _
      ...
      .Executes(() =>
      {
        DotNetBuild(s => s
              ...
              .SetAssemblyVersion("2.3.4")
              .SetFileVersion("2.3.4")
              .SetInformationalVersion("2.3.4+OP17.2-R2026")
              .EnableNoRestore());
      });
  ...
  Target PublishGitHubRelease => _ => _
      ...
      .Executes(async () =>
      {
        var releaseTag = "v2.3.4";
        var isStableRelease = true;
  ...
  Target BuildDocumentation => _ => _
      ...
      .Executes(async () =>
      {
        ...
        DocFXBuild(x => x
              .SetProcessEnvironmentVariable("DOCFX_SOURCE_BRANCH_NAME", "main")
